...
export default function ContentManagement({ type, isSuperAdmin, isAdmin }: Props) {
    ...
    return (
        <div className="space-y-4">
            ...
            {type === "minbabat" && (
                <div className="grid gap-4">
                    {Object.entries(minbabatData).map(([day, categories]: [string, any]) => (
                        <div key={day} className="bg-white rounded-lg shadow p-6">
                            <h3 className="text-lg font-bold text-green-700 mb-4">{day}</h3>
                            <div className="space-y-3">
                                {Object.entries(categories).map(([category, reading]: [string, any]) => (
                                    <div key={category} className="border-l-4 border-green-500 pl-4">
                                        <div className="flex justify-between items-start mb-2">
                                            ...
                                            {canEdit && (
                                                <button
                                                    onClick={() => openEditModal({ day, category, ...reading })}
                                        ...
                                        <p className="text-sm text-gray-700">{reading.content.substring(0, 100)}...</p>
                                    </div>
                                ))}
                            </div>
                        </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                                <p className="text-sm text-gray-700">
                                    <strong>Selected Day:</strong> {formData.dayOfWeek || "Not selected"}
                                </p>
                            </div>
                            <textarea
                        ...
                        <div className="space-y-4">
                            ...
                            {showEditModal && (
                                <div className="bg-gray-50 border rounded-lg p-3">
                                    <p className="text-sm text-gray-700">
                                        <strong>Day:</strong> {selectedItem?.day}<br />
