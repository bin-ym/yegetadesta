...
export default function UserManagement({ currentUser, isSuperAdmin, initData }: Props) {
    ...
    const handleAddUser = () => {
        const newUser: User = {
            ...
            baptismName: formData.baptismName || null,
                            ...
                            {filteredUsers.map((user) => (
                                <tr key={user.id} className="hover:bg-gray-50">
                                    ...
                                    <td className="px-4 py-3 text-center">
                                        <span
                                            className={`text-xs px-2 py-1 rounded-full font-medium ${user.role === "SUPER_ADMIN"
